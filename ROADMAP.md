...
| A12 | Zweispaltiges Layout | Konzept | TODO | `feat/a12-two-column` | `preprocessing-wizard.component.*`, `shared/progress-stepper/` |
...
**Typ:** Konzept · **Miro:** Neue two column UI, Neuer Schritt 4 Anpassung · **Status:** TODO · **Branch:** `feat/a12-two-column`
**Befund:** K-01
