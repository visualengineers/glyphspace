...
export function drawFlowerGlyph(
  ...
  if (allZero) {
    ...
    keys.forEach((key, i) => {
      ...
      path.moveTo(0, 0);
      path.bezierCurveTo(petalWidth * 0.25, -petalLength * 0.3, petalWidth * 0.6, -petalLength * 0.75, 0, -petalLength);
      path.bezierCurveTo(-petalWidth * 0.6, -petalLength * 0.75, -petalWidth * 0.25, -petalLength * 0.3, 0, 0);
...
function drawLabels(
  ...
  context.font =
    '11px "Lucida Sans", "Lucida Sans Regular", "Lucida Grande", "Lucida Sans Unicode", Geneva, Verdana, sans-serif';
